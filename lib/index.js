 ...
 * @param {Object} backboneEntities - Backbone entity or object created by `combinedBBEntities`.
 * @returns {Object} JSON representation of the backboneEntities passed in.
 */
export const bbReducer = (backboneEntities) => () => backboneEntities.toJSON();
 ...
 */
export const bbCreateStore = (storeCreator = createStore) => (backboneEntities, enhancer = noop) => {
    const combinedBBEntities = bbCombineEntities(backboneEntities);
 ...
 * @returns {void}
 */
export const bbDispatch = (backboneEntity, type, payload) => backboneEntity.trigger(BB_EVENT_NAME, { type, payload });
